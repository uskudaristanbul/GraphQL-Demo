...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=sql.zeus.domainhizmetleri.net;Database=tekyerco_Doory;User Id=tekyerco_doory; Password=Marmara.1234");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Career>(entity =>
            {
                entity.HasOne(d => d.Account)
                    ...
                    .HasConstraintName("FK_Careers_Accounts");
            ...
            modelBuilder.Entity<Slot>(entity =>
            {
                entity.HasOne(d => d.Store)
                    .WithMany(p => p.Slot)
                    .HasForeignKey(d => d.StoreId)
                    .HasConstraintName("FK_Slots_stores");
            });
